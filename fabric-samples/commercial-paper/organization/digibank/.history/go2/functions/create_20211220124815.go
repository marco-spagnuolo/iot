...
func Create(idUser string, id string, temperature float32, humidity float32, owner string) ([]byte, error) {
	...
	result, err := contract.SubmitTransaction("CreateAsset", id, temperature, humidity, owner)
	if err != nil {
