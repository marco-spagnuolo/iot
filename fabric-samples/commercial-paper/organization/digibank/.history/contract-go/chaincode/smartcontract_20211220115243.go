...
func (s *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
	assets := []Asset{
		{ID: "asset1", Temperature: 23.5, Owner: "CHECKTEMP"},
	}
...
func (s *SmartContract) CreateAsset(ctx contractapi.TransactionContextInterface, id string, temperature float32, humidity float32, owner string) error {
...
func (s *SmartContract) UpdateAsset(ctx contractapi.TransactionContextInterface, id string, temperature float32, humidity float32, owner string) error {
	exists, err := s.AssetExists(ctx, id)
	if err != nil {
		return err
	}
