...
func Mint(idUser string) ([]byte, error) {
	MintAmount := 5000
	...
	defer log.Printf("==============> CreateAsset %v program complete", idUser)
	defer gw.Close()
	...
	log.Println("--> Submit Transaction: Mint")
	result, err := contract.SubmitTransaction("Mint", MintAmount)
	if err != nil {
